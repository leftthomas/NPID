# NPID
A PyTorch implementation of NPID based on CVPR 2018 paper [Unsupervised Feature Learning via Non-Parametric Instance Discrimination](https://arxiv.org/abs/1805.01978).
