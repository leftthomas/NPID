...
# TODO
rgb_mean = {'waymo': [0.4853, 0.4965, 0.4295], 'uisee': [0.4707, 0.4601, 0.4549]}
rgb_std = {'waymo': [0.2237, 0.2193, 0.2568], 'uisee': [0.2767, 0.2760, 0.2850]}
data_path = {'waymo': '/home/data/waymo', 'uisee': '/home/data/uisee'}
...
class ImageReader(Dataset):
    ...
    def __init__(self, data_name, data_type, ensemble_size=None, meta_class_size=None, load_ids=False):
        # TODO
